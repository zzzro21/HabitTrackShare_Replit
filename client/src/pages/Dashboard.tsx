    ...
    <div className="max-w-md mx-auto bg-gray-50 min-h-screen shadow-lg pb-16 relative">
      ...
      <div className="mx-2 p-5 pb-6 bg-blue-100/80 rounded-3xl border border-blue-200 shadow-sm w-[98%]">
        <div className="flex justify-between items-center mb-1">
          ...
          <button 
            className="flex items-center justify-center bg-white text-gray-600 rounded-full p-2 shadow-md border border-gray-200 transition-all hover:shadow-lg hover:bg-gray-50"
            onClick={() => {
