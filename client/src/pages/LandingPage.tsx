    ...
    >
      ...
      <div className="relative flex flex-col items-center px-8 pt-6 pb-24 z-10 flex-grow">
        ...
        <div className="w-full text-center mt-8">
          <h1 className={`text-4xl font-bold leading-tight transition-all duration-500 font-montserrat ${showAnimation ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
