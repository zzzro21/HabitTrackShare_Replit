    ...
    >
      ...
      <div className="relative flex flex-col items-center px-8 pt-6 pb-24 z-10 flex-grow">
        ...
        <div className="w-full text-center mt-8">
          ...
          <div className="flex items-center mt-4 justify-center relative">
            ...
            <span className={`text-gray-800 ml-3 absolute right-28 transition-opacity duration-500 ${showAnimation ? 'opacity-100' : 'opacity-0'} delay-400`}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
