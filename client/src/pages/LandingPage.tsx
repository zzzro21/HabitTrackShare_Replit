  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center px-8 pt-10 pb-10 z-10 flex-grow">
        {/* 타원형 이미지 컨테이너 */}
        <div className={`w-full max-w-[240px] relative mt-0 mb-8 transition-all duration-500 ${showAnimation ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
          {/* Vibes 버블 - 좌측 */}
          ...
          <div className="w-full overflow-hidden bg-orange-100 border-4 border-white shadow-xl relative" style={{ height: '280px', width: '240px', borderRadius: '100% / 35%' }}>
            <img
              src={selectedImage}
              alt="프로필 이미지"
