      ...
      <div className="relative flex flex-col items-center px-8 pt-6 pb-24 z-10 flex-grow">
        ...
        <div className="w-full text-center mt-8">
          ...
          <div className="flex items-center mt-8 justify-center relative">
            <span className={`text-red-500 mr-3 absolute -top-6 left-4 transform -translate-y-1/4 transition-opacity duration-500 ${showAnimation ? 'opacity-100' : 'opacity-0'} delay-200`}>
        ...
        <div className="w-full mt-auto">
          <button
            ...
            className={`w-full bg-orange-400 hover:bg-orange-500 text-white font-bold py-6 px-8 rounded-full text-3xl shadow-xl transform transition-all duration-500 font-singleday ${showAnimation ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} delay-500`}
          >
            시작하기
          </button>
