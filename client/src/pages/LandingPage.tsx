      ...
      <div className="relative flex flex-col items-center px-8 pt-6 pb-24 z-10 flex-grow">
        ...
        <div className="w-full text-center mt-8">
          ...
          <div className="flex items-center mt-8 justify-center relative">
            ...
            <p className={`text-gray-700 text-2xl text-center max-w-md mx-auto transition-all duration-500 font-pen ${showAnimation ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'} delay-300 whitespace-pre-line`} style={{ fontSize: '1.8rem' }}>
              "{quote}"
            </p>
