...
const TabNavigation: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 w-full bg-white border-t border-gray-200 p-1 max-w-[420px] mx-auto lg:max-w-[800px]">
      <div className="flex justify-around items-center">
        ...
        >
          ...
          <span className="text-xs mt-1">Habit Tracker</span>
        </a>
